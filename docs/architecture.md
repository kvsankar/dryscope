...
- tree-sitter extraction of CodeUnit dataclasses from Python and JavaScript/TypeScript families
...
### M4: Multi-language ✓
- JavaScript/JSX/TypeScript/TSX support (parsing, normalization, arrow functions)
