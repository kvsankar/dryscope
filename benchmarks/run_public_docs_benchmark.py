...
def main() -> None:
    ...
    parser.add_argument("--repos-dir", default="/tmp/dryscope-public-docs-benchmark-repos")
    parser.add_argument("--out-dir", default="/tmp/dryscope-public-docs-benchmark-results")
    ...
    for repo in manifest["repos"]:
        ...
        (out_dir / f"{repo['name']}.json").write_text(json.dumps(report, indent=2))
        _copy_report_artifacts(dest, artifact_root / repo["name"], metadata)
        rows.append(row)
